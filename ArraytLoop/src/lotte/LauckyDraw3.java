...
//		};
		...
		// 결과배열에 담긴 중복없는  행운 번호 6개를 오름차순(내림차순)으로 정렬??
		// Sort 정렬... 특정 기준으로 데이터들의 순서를 재배치하는것.. (알고리즘)
		Arrays.sort(selBalls); // 오름차순으로 배열의 요소의 순서들을 재배치 정렬 수행
