...
//											, false); // 모달리스 modaless
		...
		JLabel lbInfo = new JLabel(about, JLabel.CENTER);
...
public class JMemoFrame7 extends JFrame implements ActionListener {
	// 상수 선언
...
//		this.add(lbStatus, BorderLayout.SOUTH);//상태바
	...
	public static void main(String[] args) {
		JMemoFrame7 frm = new JMemoFrame7("나의 메모장2");
		// frm.setVisible(true);
	}

	// 이벤트 처리 콜백함수(callback)
	@Override
	public void actionPerformed(ActionEvent e) {
		// ActionEvent e 콜백이 발동될때 의 이벤트 문맥 정보 객체
		...
		if (this.btnSave == evBtn) {
			...
			System.out.println("아직 처리할 수 없습니다");
		}
