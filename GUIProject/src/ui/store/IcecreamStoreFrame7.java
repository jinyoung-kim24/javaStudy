...
/*
 		...
 		* 아이스크림들을 담는 그릇(용기) 번들: 오직 한종류의 것만 선택(배타성) radiobutton
 		...
 		해프갤론컵		8			23000
 */
public class IcecreamStoreFrame7 extends JFrame implements ActionListener, ItemListener {
	// 인터페이스 다중 구현 
