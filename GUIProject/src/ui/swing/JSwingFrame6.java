...
public class JSwingFrame6 extends JFrame
...
//		frm.setVisible(true);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if( evBtn == btnNum1 ) { // 주소까지 동일한 버튼?
			...
			int	result = 0;
			switch (selOP) {
			case PLUS: result = this.first + this.second;
			System.out.printf(" %d + %d = %d \n", first, 
					second, result);
				break;
			case MINUS:result = this.first - this.second;
			System.out.printf(" %d - %d = %d \n", first, 
					second, result);
				break;
			case MULTIPY:result = this.first * this.second;
			System.out.printf(" %d * %d = %d \n", first, 
					second, result);
				break;
			case DIVIDE:result = this.first / this.second;
			System.out.printf(" %d / %d = %d \n", first, 
					second, result);
				break;
			}
