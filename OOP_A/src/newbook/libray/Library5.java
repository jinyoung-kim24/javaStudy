...
//		bk1.printBook();	
		...
		Book bk3 = new Book(103, "황금알을 낳는 거위", "김진영", 2);
		...
		Book bk5 = new Book("부자 아빠 가난한 아빠 20주년 특별 기념판", "기요사키", 2, "giyo/richdad.jpg",
...
//		bk5.decreaseRate();
		...
		Book bk6 = new Book("안녕 앤 - 어린시절 앤의 이야기", "월슨", 3, "red/book/ann.gif",
