...
public class FoodsMainFrame extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FoodsMainFrame frame = new FoodsMainFrame();
	...
	public FoodsMainFrame(formealMainFrame searchfrm,String foodType,String cookMinute,String eatPerson,String cookGrade 
