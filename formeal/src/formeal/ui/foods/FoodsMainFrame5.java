...
public class FoodsMainFrame5 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FoodsMainFrame5 frame = new FoodsMainFrame5();
...
//				
//			
//			JButton btnBasket= new JButton("a");
////			btnBasket.setSize(10, 10);
//			JButton btnRecipe= new JButton("b");
