...
//import java.awt.BorderLayout;              //커다란 버튼 두개
...
public class FoodsMainFrame3 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FoodsMainFrame3 frame = new FoodsMainFrame3();
...
//		
//		panelInBtn.setLayout(new GridLayout(0, 2, 0, 0));
//		
