...
public class foodsMainFrame_backup2 extends JFrame {
	private formealMainFrame searchfrm;
	private foodsMainFrame_backup2 resultfrm;
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					foodsMainFrame_backup2 frame = new foodsMainFrame_backup2();
	 ...
	 * Create the frame.
	 */
	public foodsMainFrame_backup2() {
		this.searchfrm=searchfrm;
	}
	//
	public foodsMainFrame_backup2(formealMainFrame searchfrm) {
		this.searchfrm=searchfrm;
...
//					+ 1000 + "원";
			...
			ImageIcon icon = new 
				ImageIcon("C:\\Users\\rbwls\\Documents\\\uCE74\uCE74\uC624\uD1A1 \uBC1B\uC740 \uD30C\uC77C\\\uBD84\uC2DD-\uB5A1\uBCF6\uC774(\uC218\uC8158.png");
			JLabel lbfoodImage1 = 
		...
		lbfoodImage2.setIcon(new ImageIcon("C:\\Users\\rbwls\\Documents\\\uCE74\uCE74\uC624\uD1A1 \uBC1B\uC740 \uD30C\uC77C\\\uBD84\uC2DD-\uB5A1\uBCF6\uC774(\uC218\uC8158.png"));
