	...
	private static char userInputToOperator(
		...
		if( checked ) { // 오류검출 옵션 켜다
			...
			while(flag) { // == true) {
				...
				switch( inputOp ) {
					case 1: op = OP_ADD; flag = false; break;
					case 2: op = OP_SUBTRACT;  flag = false; break;
					case 3: op = OP_MULTIPLY;  flag = false; break;
					case 4: op = OP_DIVIDE;  flag = false; break;
					case 5: op = OP_REM;  flag = false; break;
					default:
