...
// 임포트를 통해서 이 소스코드 클래스 BranchMain8 안에서
// 날짜 시간을 처리하는 기능을 Data에 빌려쓰겠다는 선언. 
...
//		purchaseMile = (int) Math.round(price * 0.01);
	...
	public static void main(String[] args) {		
		...
		while(flag) {
			...
			// 회차 활동 언제 실행되었나? 날짜 시간..
		Date actTime  = new Date(); // 날짜시간 객체 생성
		 	// java.utill.Date JVM이 실행중인 OS의 지역 시간을 가져옴.
		String actStamp = "[" + actTime + "]";
		// UTC + 9, GMT + 9 timezone 개념.... 위도경도 
