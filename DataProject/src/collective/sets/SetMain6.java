...
//		HashSet<Character> hs = new HashSet<Character>(); // ok
		...
		// 교집합(intersection)
		HashSet<Character> intersection = new HashSet<>(); // 공집합{}
		// hsA ∩ hsB == intersection
//		// 두 집합의 모든 요소들을 서로 각각 모두 비교?
//		for (Character cA : hsA) {
//			for (Character cB : hsB) {
//				// 같은 요소 발견 시 교집합에 저장
//				if(cA == cB) { // 교집합에 넣을 요소가 발견!
//				intersection.add(cA);
//				break;
//				}
//			}
//		}
		...
		printCharSet(intersection, "교집합 hsA ∩ hsB");
	}
