...
//		};
		...
		String[] theme1Names = {"Aqua", "Lime", "MediumVioletRed", "Chocolate", "MediumSlateBlue", "Tomato"};
		String[] theme1Codes = {"0x00FFFF", "0x00FF00", "0xC71585", "0xD2691E", "0x7B68EE", "0xFF6347"};
		
		// 테마 컬러 샘플 출력...
		int rows = theme1Names.length; // 색상 수
		String titleContent = "테마 컬러 wiki color - "+rows+"색 팔레트";
	...
	private static String makeColorTable(String[] theme1Names, String[] theme1Codes) {
		...
		for (int i = 0; i < theme1Names.length; i++) {					
			table += "<tr bgcolor='#"+
				...
				+"'> <td> "+theme1Names[i]
				+" 색 </td> <td> <i>"+theme1Codes[i]+"</i> </td> </tr>";
		}
		// 
		table += "</table>";
		return table;
